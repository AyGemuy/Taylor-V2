...
const timeout = 18e5,
  handler = async (m, { conn, usedPrefix, text }) => {
    ...
    if (new Date() - db.data.users[m.sender].lastberkebon < 18e5)
        ...
        if (db.data.users[m.sender].bibitpisang > 499)
          if (db.data.users[m.sender].bibitjeruk > 499)
            if (db.data.users[m.sender].bibitanggur > 499) {
              ...
              (db.data.users[m.sender].pisang += 1 * pisangpoin),
                (db.data.users[m.sender].anggur += 1 * anggurpoin),
                (db.data.users[m.sender].mangga += 1 * manggapoin),
                (db.data.users[m.sender].jeruk += 1 * jerukpoin),
                (db.data.users[m.sender].apel += 1 * apelpoin),
                ...
                (db.data.users[m.sender].lastberkebon = 1 * new Date());
