...
const handler = async (m, { conn, args, text, usedPrefix, command }) => {
  let who =
    ...
    one = urut[1],
    two = urut[2],
    template = (urut[3], (args[0] || "").toLowerCase());
  if (!args[0]) {
    ...
    if (command)
      switch (template) {
        case "listsurah":
          axios
            .get(
              `https://api.lolhuman.xyz/api/quran?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
              var teks = "List Surah:\n";
        ...
        case "alquran":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/quran/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
              ...
              for (var x of ayat)
                teks += `${x.arab}\n${x.ayat}. ${x.latin}\n${x.indonesia}\n\n`;
              (teks = (teks = teks.replace(/<u>/g, "_").replace(/<\/u>/g, "_"))
                .replace(/<strong>/g, "*")
                .replace(/<\/strong>/g, "*")),
                await conn.reply(m.chat, teks, m);
            })
        ...
        case "asmaulhusna":
          axios
            .get(
              `https://api.lolhuman.xyz/api/asmaulhusna?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "kisahnabi":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Muhammad`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/kisahnabi/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "jadwalsholat":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Yogyakarta`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/sholat/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "ytplay":
          if (!one)
            return await m.reply(
              `Example: ${usedPrefix + command} ${template} |melukis senja`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/ytsearch?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              axios
                .get(
                  `https://api.lolhuman.xyz/api/ytaudio2?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=https://www.youtube.com/watch?v=${data.result[0]?.videoId}`,
                )
                .then(async ({ data }) => {
        ...
        case "ytmp3":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/ytaudio2?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              var caption = `❖ Title    : *${data.result.title}*\n`;
              (caption += `❖ Size     : *${data.result.size}*`),
        ...
        case "ytmp4":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/ytmp4?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              var caption = `❖ Title    : *${data.result.title}*\n`;
              (caption += `❖ Size     : *${data.result.size}*`),
        ...
        case "telesticker":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/telestick?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                sticker: {
        ...
        case "tiktoknowm":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |https://vt.tiktok.com/ZSwWCk5o/`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/tiktok?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                video: {
        ...
        case "spotify":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/spotify?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              var caption = `Title : ${data.result.title}\n`;
        ...
        case "spotifysearch":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/spotifysearch?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              var teks = "";
              for (var x of data.result)
        ...
        case "jooxplay":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/jooxplay?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
        ...
        case "igdl":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/instagram?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              var url = data.result;
              url.includes(".mp4")
        ...
        case "igdl2":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/instagram2?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              for (var x of data.result)
                x.includes(".mp4")
        ...
        case "twtdl":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/twitter?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                video: {
        ...
        case "fbdl":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/facebook?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                video: {
        ...
        case "zippyshare":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/zippyshare?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
        ...
        case "pinterest":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |loli kawaii`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/pinterest?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                image: {
        ...
        case "pinterest2":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/pinterest2?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
        ...
        case "pinterestdl":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/pinterestdl?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                image: {
        ...
        case "pixivdl":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |63456028`,
            );
          conn.sendMessage(m.chat, {
            image: {
        ...
        case "character":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Miku Nakano`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/character?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
        ...
        case "manga":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/manga?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              var caption = `Id : ${data.result.id}\n`;
        ...
        case "anime":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/anime?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              var caption = `Id : ${data.result.id}\n`;
              for (var x of ((caption += `Id MAL : ${data.result.idMal}\n`),
        ...
        case "kusonime":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/kusonime?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              var caption = `Title : ${data.result.title}\n`;
        ...
        case "kusonimesearch":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/kusonimesearch?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              var caption = `Title : ${data.result.title}\n`;
              for (var x in ((caption += `Japanese : ${data.result.japanese}\n`),
        ...
        case "otakudesu":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/otakudesu?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
        ...
        case "otakudesusearch":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/otakudesusearch?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              var teks = `Title : ${data.result.title}\n`;
              for (var x in ((teks += `Japanese : ${data.result.japanese}\n`),
        ...
        case "kbbi":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |kursi`,
            );
          var { data } = await axios.get(
              `https://api.lolhuman.xyz/api/kbbi?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            ),
            teks = `\`\`\`Kata : ${data.result[0]?.nama}\`\`\`\n`;
        ...
        case "brainly":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |siapakah sukarno`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/brainly?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
        ...
        case "jarak":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |jakarta|yogyakarta`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/jaraktempuh?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&kota1=${one}&kota2=${two}`,
          );
        ...
        case "urbandictionary":
          var { data } = await axios.get(
            `http://api.lolhuman.xyz/api/urdict?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
          for (var x of data.result) {
            teks = `\`\`\`Meaning :\n${x.definition}\`\`\`\n\n`;
        ...
        case "chord":
          ...
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/chord?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
        ...
        case "heroml":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Fanny`,
            );
          var { data } = await axios.get(
              `https://api.lolhuman.xyz/api/heroml/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            ),
            caption = `Name : ${data.result.hero_name}\n`;
        ...
        case "mlstalk":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |84830127/2169`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/mobilelegend/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          m.reply(data.result);
          break;
        case "genshin":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |jean`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/genshin/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
        ...
        case "wikipedia":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Tahu`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/wiki?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
          m.reply(data.result);
          break;
        case "translate":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |en|Tahu Bacem`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/translate/auto/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&text=${two}`,
          );
        ...
        case "brainly":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Soekarno adalah`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/brainly?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
        ...
        case "jadwaltv":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |RCTI`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/jadwaltv/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
        ...
        case "jadwaltvnow":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/jadwaltv/now?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Jadwal TV Now :\n";
        ...
        case "newsinfo":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/newsinfo?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Result :\n";
          for (var x of data.result)
            (teks += `Title : ${x.title}\n`),
        ...
        case "cnnindonesia":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/cnnindonesia?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Result :\n";
          for (var x of data.result)
            (teks += `Judul : ${x.judul}\n`),
        ...
        case "cnnnasional":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/cnnindonesia/nasional?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Result :\n";
          for (var x of data.result)
            (teks += `Judul : ${x.judul}\n`),
        ...
        case "cnninternasional":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/cnnindonesia/internasional?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Result :\n";
          for (var x of data.result)
            (teks += `Judul : ${x.judul}\n`),
        ...
        case "infogempa":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/infogempa?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
        ...
        case "lirik":
          ...
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/lirik?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
          m.reply(data.result);
          break;
        case "cuaca":
          ...
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/cuaca/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
        ...
        case "covidindo":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/corona/indonesia?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
        ...
        case "covidglobal":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/corona/global?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = `Positif : ${data.result.positif}\n`;
          (teks += `Sembuh : ${data.result.sembuh}\n`),
            (teks += `Dirawat : ${data.result.dirawat}\n`),
        ...
        case "kodepos":
          ...
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/kodepos?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
        ...
        case "jadwalbola":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/jadwalbola?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Jadwal Bola :\n";
          for (var x of data.result)
            (teks += `Hari : ${x.hari}\n`),
        ...
        case "indbeasiswa":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/indbeasiswa?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Info Beasiswa :\n";
          for (var x of data.result)
            (teks += `Title : ${x.title}\n`), (teks += `Link : ${x.link}\n\n`);
        ...
        case "hoax":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/turnbackhoax?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Info Hoax :\n";
          for (var x of data.result)
            (teks += `Title : ${x.title}\n`),
        ...
        case "lk21":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Transformer`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/lk21?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
        ...
        case "drakorongoing":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/drakorongoing?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = "Ongoing Drakor\n\n";
          for (var x of data.result)
            (teks += `Title : ${x.title}\n`),
        ...
        case "wattpad":
          ...
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/wattpad?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
          );
          caption = `Title : ${data.result.title}\n`;
          (caption += `Rating : ${data.result.rating}\n`),
        ...
        case "wattpadsearch":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Tere Liye`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/wattpadsearch?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
          teks = "Wattpad Seach : \n";
          for (var x of data.result)
            (teks += `Title : ${x.title}\n`),
        ...
        case "cerpen":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/cerpen?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          teks = `Title : ${data.result.title}\n`;
        ...
        case "ceritahoror":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/ceritahoror?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          caption = `Title : ${data.result.title}\n`;
          (caption += `Desc : ${data.result.desc}\n`),
            (caption += `Story :\n${data.result.story}\n`),
        ...
        case "wallpapersearch":
          ...
          "wallpapersearch" === command && (command = "wallpaper"),
            conn.sendMessage(m.chat, {
              image: {
        ...
        case "gimage2":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/gimage2?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              for (var x of data.result.slice(0, 5))
                conn.sendMessage(m.chat, {
        ...
        case "wallpapersearch2":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/wallpaper2?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                image: {
        ...
        case "playstore":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |telegram`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/playstore?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
        ...
        case "shopee":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |tas gendong`,
            );
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/shopee?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
          teks = "Shopee Search : \n";
          for (var x of data.result)
            (teks += `Name : ${x.name}\n`),
        ...
        case "google":
          ...
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/gsearch?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&query=${one}`,
          );
          teks = "Google Search : \n";
          for (var x of data.result)
            (teks += `Title : ${x.title}\n`),
        ...
        case "quotes":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/random/quotes?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          m.reply(`_${data.result.quote}_\n\n*― ${data.result.by}*`);
          break;
        case "quotesanime":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/random/quotesnime?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          m.reply(
        ...
        case "quotesdilan":
          (quotedilan = await axios.get(
            `https://api.lolhuman.xyz/api/quotes/dilan?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          )),
        ...
        case "bucin":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/random/${teks}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          m.reply(data.result);
          break;
        case "randomnama":
          var { data } = await axios.get(
            `https://api.lolhuman.xyz/api/random/nama?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
          );
          m.reply(data.result);
          break;
        case "asupan":
          axios
            .get(
              `https://api.lolhuman.xyz/api/asupan?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
              conn.sendMessage(m.chat, {
                video: {
        ...
        case "artinama":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Taylor MD`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/artinama?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&nama=${one}`,
            )
            .then(async ({ data }) => {
              m.reply(data.result);
            });
        ...
        case "jodoh":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |Tahu|Bacem`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/jodoh/${one}/${two}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "weton":
          if (!args[1])
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |12 12 2020`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/weton/${args[1]}/${args[2]}/${args[3]}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "jadian":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/jadian/${args[1]}/${args[2]}/${args[3]}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "tebakumur":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/tebakumur?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&name=${one}`,
            )
            .then(async ({ data }) => {
        ...
        case "stalkig":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |jessnolimit`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/stalkig/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "stalkgithub":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |LoL-Human`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/github/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "stalktwitter":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |jokowi`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/twitter/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
        ...
        case "stalktiktok":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |bulansutena`,
            );
          axios
            .get(
              `https://api.lolhuman.xyz/api/stalktiktok/${one}?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}`,
            )
            .then(async ({ data }) => {
              var caption = `Username : ${data.result.username}\n`;
        ...
        case "ssweb":
          if (!one)
            return m.reply(
              `Example: ${usedPrefix + command} ${template} |https://api.lolhuman.xyz`,
            );
          conn.sendMessage(m.chat, {
            image: {
        ...
        case "shortlink":
          ...
          axios
            .get(
              `https://api.lolhuman.xyz/api/ouoshortlink?apikey=${Object.entries(APIKeys).find(([key]) => key.includes("lolhuman"))?.[1]}&url=${one}`,
            )
            .then(async ({ data }) => {
              m.reply(data.result);
            });
